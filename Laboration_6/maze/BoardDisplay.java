...
public class BoardDisplay extends Board implements Observer {
	...
	public void update(Observable o, Object arg) {
		if(o instanceof Maze && arg instanceof Pair){
			@SuppressWarnings("unchecked")
			Pair<Integer,Point.Direction> p = (Pair)arg;
			knockDownWall(p.first,p.second);
		}
		else if(o instanceof Maze && arg instanceof List){
			@SuppressWarnings("unchecked")
			List<Integer> l = (List<Integer>)arg;
